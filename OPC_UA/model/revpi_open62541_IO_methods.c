...
attr.description = UA_LOCALIZEDTEXT("", "Ejector");
attr.writeMask = 0;
attr.userWriteMask = 0;
retVal |= UA_Server_addNode_begin(server, UA_NODECLASS_METHOD,
UA_NODEID_NUMERIC(ns[1], 5001),
UA_NODEID_NUMERIC(ns[0], 2001),
UA_NODEID_NUMERIC(ns[0], 85),
UA_NODEID_NUMERIC(ns[0], 47),
UA_QUALIFIEDNAME(ns[1], "Ejector"),
 UA_NODEID_NULL,
...
attr.executable = true;
attr.userExecutable = true;
attr.displayName = UA_LOCALIZEDTEXT("", "Stack Magazine");
attr.description = UA_LOCALIZEDTEXT("", "Stack Magazine");
attr.writeMask = 0;
attr.userWriteMask = 0;
retVal |= UA_Server_addNode_begin(server, UA_NODECLASS_METHOD,
...
UA_NODEID_NUMERIC(ns[0], 85),
UA_NODEID_NUMERIC(ns[0], 47),
UA_QUALIFIEDNAME(ns[1], "Stack Magazine"),
 UA_NODEID_NULL,
(const UA_NodeAttributes*)&attr, &UA_TYPES[UA_TYPES_METHODATTRIBUTES],NULL, NULL);
return retVal;
#else
...
} variablenode_ns_1_i_2001_Argument_0_0_struct;
variablenode_ns_1_i_2001_Argument_0_0_struct.Name = UA_STRING("position");
variablenode_ns_1_i_2001_Argument_0_0_struct.DataType = UA_NODEID_NUMERIC(ns[0], 1);
variablenode_ns_1_i_2001_Argument_0_0_struct.ValueRank = (UA_Int32) -1;
variablenode_ns_1_i_2001_Argument_0_0_struct.ArrayDimensionsSize = 1;
variablenode_ns_1_i_2001_Argument_0_0_struct.ArrayDimensions = (UA_UInt32*) UA_malloc(sizeof(UA_UInt32));
variablenode_ns_1_i_2001_Argument_0_0_struct.ArrayDimensions[0]  = (UA_UInt32) 0;
variablenode_ns_1_i_2001_Argument_0_0_struct.Description = UA_LOCALIZEDTEXT("", "Actual position: 1/TRUE (extended), 0/FALSE (retracted)");
UA_ExtensionObject *variablenode_ns_1_i_2001_Argument_0_0 =  UA_ExtensionObject_new();
variablenode_ns_1_i_2001_Argument_0_0->encoding = UA_EXTENSIONOBJECT_ENCODED_BYTESTRING;
variablenode_ns_1_i_2001_Argument_0_0->content.encoded.typeId = UA_NODEID_NUMERIC(0, 298);
UA_ByteString_allocBuffer(&variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body, 65000);
UA_Byte *posvariablenode_ns_1_i_2001_Argument_0_0 = variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.data;
const UA_Byte *endvariablenode_ns_1_i_2001_Argument_0_0 = &variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.data[65000];
{
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2001_Argument_0_0_struct.Name, &UA_TYPES[UA_TYPES_STRING], &posvariablenode_ns_1_i_2001_Argument_0_0, &endvariablenode_ns_1_i_2001_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2001_Argument_0_0_struct.DataType, &UA_TYPES[UA_TYPES_NODEID], &posvariablenode_ns_1_i_2001_Argument_0_0, &endvariablenode_ns_1_i_2001_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2001_Argument_0_0_struct.ValueRank, &UA_TYPES[UA_TYPES_INT32], &posvariablenode_ns_1_i_2001_Argument_0_0, &endvariablenode_ns_1_i_2001_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2001_Argument_0_0_struct.ArrayDimensions[0], &UA_TYPES[UA_TYPES_UINT32], &posvariablenode_ns_1_i_2001_Argument_0_0, &endvariablenode_ns_1_i_2001_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2001_Argument_0_0_struct.Description, &UA_TYPES[UA_TYPES_LOCALIZEDTEXT], &posvariablenode_ns_1_i_2001_Argument_0_0, &endvariablenode_ns_1_i_2001_Argument_0_0, NULL, NULL);
}
size_t variablenode_ns_1_i_2001_Argument_0_0_encOffset = (uintptr_t)(posvariablenode_ns_1_i_2001_Argument_0_0-variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.data);
variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.length = variablenode_ns_1_i_2001_Argument_0_0_encOffset;
UA_Byte *variablenode_ns_1_i_2001_Argument_0_0_newBody = (UA_Byte *) UA_malloc(variablenode_ns_1_i_2001_Argument_0_0_encOffset);
memcpy(variablenode_ns_1_i_2001_Argument_0_0_newBody, variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.data, variablenode_ns_1_i_2001_Argument_0_0_encOffset);
UA_Byte *variablenode_ns_1_i_2001_Argument_0_0_oldBody = variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.data;
variablenode_ns_1_i_2001_Argument_0_0->content.encoded.body.data = variablenode_ns_1_i_2001_Argument_0_0_newBody;
UA_free(variablenode_ns_1_i_2001_Argument_0_0_oldBody);

UA_ExtensionObject variablenode_ns_1_i_2001_variant_DataContents[1];
variablenode_ns_1_i_2001_variant_DataContents[0] = *variablenode_ns_1_i_2001_Argument_0_0;
UA_Variant_setArray(&attr.value, &variablenode_ns_1_i_2001_variant_DataContents, (UA_Int32) 1, &UA_TYPES[UA_TYPES_EXTENSIONOBJECT]);
...
UA_QUALIFIEDNAME(ns[1], "InputArguments"),
UA_NODEID_NUMERIC(ns[0], 68),
(const UA_NodeAttributes*)&attr, &UA_TYPES[UA_TYPES_VARIABLEATTRIBUTES],NULL, NULL);

UA_free(variablenode_ns_1_i_2001_Argument_0_0_struct.ArrayDimensions);
UA_ExtensionObject_delete(variablenode_ns_1_i_2001_Argument_0_0);
retVal |= UA_Server_addReference(server, UA_NODEID_NUMERIC(ns[1], 2001), UA_NODEID_NUMERIC(ns[0], 37), UA_EXPANDEDNODEID_NUMERIC(ns[0], 78), true);
return retVal;
}
...
struct {
  ...
  UA_UInt32 *ArrayDimensions;
  UA_LocalizedText Description;
} variablenode_ns_1_i_2002_Argument_0_0_struct;
variablenode_ns_1_i_2002_Argument_0_0_struct.Name = UA_STRING("position");
variablenode_ns_1_i_2002_Argument_0_0_struct.DataType = UA_NODEID_NUMERIC(ns[0], 1);
variablenode_ns_1_i_2002_Argument_0_0_struct.ValueRank = (UA_Int32) -1;
variablenode_ns_1_i_2002_Argument_0_0_struct.ArrayDimensionsSize = 1;
variablenode_ns_1_i_2002_Argument_0_0_struct.ArrayDimensions = (UA_UInt32*) UA_malloc(sizeof(UA_UInt32));
variablenode_ns_1_i_2002_Argument_0_0_struct.ArrayDimensions[0]  = (UA_UInt32) 0;
variablenode_ns_1_i_2002_Argument_0_0_struct.Description = UA_LOCALIZEDTEXT("", "Actual position: 1/TRUE (extended), 0/FALSE (retracted)");
UA_ExtensionObject *variablenode_ns_1_i_2002_Argument_0_0 =  UA_ExtensionObject_new();
variablenode_ns_1_i_2002_Argument_0_0->encoding = UA_EXTENSIONOBJECT_ENCODED_BYTESTRING;
variablenode_ns_1_i_2002_Argument_0_0->content.encoded.typeId = UA_NODEID_NUMERIC(0, 298);
UA_ByteString_allocBuffer(&variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body, 65000);
UA_Byte *posvariablenode_ns_1_i_2002_Argument_0_0 = variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.data;
const UA_Byte *endvariablenode_ns_1_i_2002_Argument_0_0 = &variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.data[65000];
{
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2002_Argument_0_0_struct.Name, &UA_TYPES[UA_TYPES_STRING], &posvariablenode_ns_1_i_2002_Argument_0_0, &endvariablenode_ns_1_i_2002_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2002_Argument_0_0_struct.DataType, &UA_TYPES[UA_TYPES_NODEID], &posvariablenode_ns_1_i_2002_Argument_0_0, &endvariablenode_ns_1_i_2002_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2002_Argument_0_0_struct.ValueRank, &UA_TYPES[UA_TYPES_INT32], &posvariablenode_ns_1_i_2002_Argument_0_0, &endvariablenode_ns_1_i_2002_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2002_Argument_0_0_struct.ArrayDimensions[0], &UA_TYPES[UA_TYPES_UINT32], &posvariablenode_ns_1_i_2002_Argument_0_0, &endvariablenode_ns_1_i_2002_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2002_Argument_0_0_struct.Description, &UA_TYPES[UA_TYPES_LOCALIZEDTEXT], &posvariablenode_ns_1_i_2002_Argument_0_0, &endvariablenode_ns_1_i_2002_Argument_0_0, NULL, NULL);
}
size_t variablenode_ns_1_i_2002_Argument_0_0_encOffset = (uintptr_t)(posvariablenode_ns_1_i_2002_Argument_0_0-variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.data);
variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.length = variablenode_ns_1_i_2002_Argument_0_0_encOffset;
UA_Byte *variablenode_ns_1_i_2002_Argument_0_0_newBody = (UA_Byte *) UA_malloc(variablenode_ns_1_i_2002_Argument_0_0_encOffset);
memcpy(variablenode_ns_1_i_2002_Argument_0_0_newBody, variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.data, variablenode_ns_1_i_2002_Argument_0_0_encOffset);
UA_Byte *variablenode_ns_1_i_2002_Argument_0_0_oldBody = variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.data;
variablenode_ns_1_i_2002_Argument_0_0->content.encoded.body.data = variablenode_ns_1_i_2002_Argument_0_0_newBody;
UA_free(variablenode_ns_1_i_2002_Argument_0_0_oldBody);

UA_ExtensionObject variablenode_ns_1_i_2002_variant_DataContents[1];
variablenode_ns_1_i_2002_variant_DataContents[0] = *variablenode_ns_1_i_2002_Argument_0_0;
UA_Variant_setArray(&attr.value, &variablenode_ns_1_i_2002_variant_DataContents, (UA_Int32) 1, &UA_TYPES[UA_TYPES_EXTENSIONOBJECT]);
...
UA_NODEID_NUMERIC(ns[1], 5001),
UA_NODEID_NUMERIC(ns[0], 46),
UA_QUALIFIEDNAME(ns[1], "OutputArguments"),
UA_NODEID_NUMERIC(ns[0], 68),
(const UA_NodeAttributes*)&attr, &UA_TYPES[UA_TYPES_VARIABLEATTRIBUTES],NULL, NULL);

UA_free(variablenode_ns_1_i_2002_Argument_0_0_struct.ArrayDimensions);
UA_ExtensionObject_delete(variablenode_ns_1_i_2002_Argument_0_0);
retVal |= UA_Server_addReference(server, UA_NODEID_NUMERIC(ns[1], 2002), UA_NODEID_NUMERIC(ns[0], 37), UA_EXPANDEDNODEID_NUMERIC(ns[0], 78), true);
return retVal;
}
...
struct {
  ...
  UA_UInt32 *ArrayDimensions;
  UA_LocalizedText Description;
} variablenode_ns_1_i_2004_Argument_0_0_struct;
variablenode_ns_1_i_2004_Argument_0_0_struct.Name = UA_STRING("position");
variablenode_ns_1_i_2004_Argument_0_0_struct.DataType = UA_NODEID_NUMERIC(ns[0], 1);
variablenode_ns_1_i_2004_Argument_0_0_struct.ValueRank = (UA_Int32) -1;
variablenode_ns_1_i_2004_Argument_0_0_struct.ArrayDimensionsSize = 1;
variablenode_ns_1_i_2004_Argument_0_0_struct.ArrayDimensions = (UA_UInt32*) UA_malloc(sizeof(UA_UInt32));
variablenode_ns_1_i_2004_Argument_0_0_struct.ArrayDimensions[0]  = (UA_UInt32) 0;
variablenode_ns_1_i_2004_Argument_0_0_struct.Description = UA_LOCALIZEDTEXT("", "Actual position: 1/TRUE (extended), 0/FALSE (retracted)");
UA_ExtensionObject *variablenode_ns_1_i_2004_Argument_0_0 =  UA_ExtensionObject_new();
variablenode_ns_1_i_2004_Argument_0_0->encoding = UA_EXTENSIONOBJECT_ENCODED_BYTESTRING;
variablenode_ns_1_i_2004_Argument_0_0->content.encoded.typeId = UA_NODEID_NUMERIC(0, 298);
UA_ByteString_allocBuffer(&variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body, 65000);
UA_Byte *posvariablenode_ns_1_i_2004_Argument_0_0 = variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.data;
const UA_Byte *endvariablenode_ns_1_i_2004_Argument_0_0 = &variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.data[65000];
{
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2004_Argument_0_0_struct.Name, &UA_TYPES[UA_TYPES_STRING], &posvariablenode_ns_1_i_2004_Argument_0_0, &endvariablenode_ns_1_i_2004_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2004_Argument_0_0_struct.DataType, &UA_TYPES[UA_TYPES_NODEID], &posvariablenode_ns_1_i_2004_Argument_0_0, &endvariablenode_ns_1_i_2004_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2004_Argument_0_0_struct.ValueRank, &UA_TYPES[UA_TYPES_INT32], &posvariablenode_ns_1_i_2004_Argument_0_0, &endvariablenode_ns_1_i_2004_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2004_Argument_0_0_struct.ArrayDimensions[0], &UA_TYPES[UA_TYPES_UINT32], &posvariablenode_ns_1_i_2004_Argument_0_0, &endvariablenode_ns_1_i_2004_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2004_Argument_0_0_struct.Description, &UA_TYPES[UA_TYPES_LOCALIZEDTEXT], &posvariablenode_ns_1_i_2004_Argument_0_0, &endvariablenode_ns_1_i_2004_Argument_0_0, NULL, NULL);
}
size_t variablenode_ns_1_i_2004_Argument_0_0_encOffset = (uintptr_t)(posvariablenode_ns_1_i_2004_Argument_0_0-variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.data);
variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.length = variablenode_ns_1_i_2004_Argument_0_0_encOffset;
UA_Byte *variablenode_ns_1_i_2004_Argument_0_0_newBody = (UA_Byte *) UA_malloc(variablenode_ns_1_i_2004_Argument_0_0_encOffset);
memcpy(variablenode_ns_1_i_2004_Argument_0_0_newBody, variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.data, variablenode_ns_1_i_2004_Argument_0_0_encOffset);
UA_Byte *variablenode_ns_1_i_2004_Argument_0_0_oldBody = variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.data;
variablenode_ns_1_i_2004_Argument_0_0->content.encoded.body.data = variablenode_ns_1_i_2004_Argument_0_0_newBody;
UA_free(variablenode_ns_1_i_2004_Argument_0_0_oldBody);

UA_ExtensionObject variablenode_ns_1_i_2004_variant_DataContents[1];
variablenode_ns_1_i_2004_variant_DataContents[0] = *variablenode_ns_1_i_2004_Argument_0_0;
UA_Variant_setArray(&attr.value, &variablenode_ns_1_i_2004_variant_DataContents, (UA_Int32) 1, &UA_TYPES[UA_TYPES_EXTENSIONOBJECT]);
attr.displayName = UA_LOCALIZEDTEXT("", "OutputArguments");
attr.description = UA_LOCALIZEDTEXT("", "OutputArguments");
attr.writeMask = 0;
attr.userWriteMask = 0;
retVal |= UA_Server_addNode_begin(server, UA_NODECLASS_VARIABLE,
UA_NODEID_NUMERIC(ns[1], 2004),
UA_NODEID_NUMERIC(ns[1], 5002),
UA_NODEID_NUMERIC(ns[0], 46),
UA_QUALIFIEDNAME(ns[1], "OutputArguments"),
UA_NODEID_NUMERIC(ns[0], 68),
...
UA_free(variablenode_ns_1_i_2004_Argument_0_0_struct.ArrayDimensions);
UA_ExtensionObject_delete(variablenode_ns_1_i_2004_Argument_0_0);
return retVal;
}
...
struct {
  ...
  UA_UInt32 *ArrayDimensions;
  UA_LocalizedText Description;
} variablenode_ns_1_i_2003_Argument_0_0_struct;
variablenode_ns_1_i_2003_Argument_0_0_struct.Name = UA_STRING("position");
variablenode_ns_1_i_2003_Argument_0_0_struct.DataType = UA_NODEID_NUMERIC(ns[0], 1);
variablenode_ns_1_i_2003_Argument_0_0_struct.ValueRank = (UA_Int32) -1;
variablenode_ns_1_i_2003_Argument_0_0_struct.ArrayDimensionsSize = 1;
variablenode_ns_1_i_2003_Argument_0_0_struct.ArrayDimensions = (UA_UInt32*) UA_malloc(sizeof(UA_UInt32));
variablenode_ns_1_i_2003_Argument_0_0_struct.ArrayDimensions[0]  = (UA_UInt32) 0;
variablenode_ns_1_i_2003_Argument_0_0_struct.Description = UA_LOCALIZEDTEXT("", "Actual position: 1/TRUE (extended), 0/FALSE (retracted)");
UA_ExtensionObject *variablenode_ns_1_i_2003_Argument_0_0 =  UA_ExtensionObject_new();
variablenode_ns_1_i_2003_Argument_0_0->encoding = UA_EXTENSIONOBJECT_ENCODED_BYTESTRING;
variablenode_ns_1_i_2003_Argument_0_0->content.encoded.typeId = UA_NODEID_NUMERIC(0, 298);
UA_ByteString_allocBuffer(&variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body, 65000);
UA_Byte *posvariablenode_ns_1_i_2003_Argument_0_0 = variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.data;
const UA_Byte *endvariablenode_ns_1_i_2003_Argument_0_0 = &variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.data[65000];
{
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2003_Argument_0_0_struct.Name, &UA_TYPES[UA_TYPES_STRING], &posvariablenode_ns_1_i_2003_Argument_0_0, &endvariablenode_ns_1_i_2003_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2003_Argument_0_0_struct.DataType, &UA_TYPES[UA_TYPES_NODEID], &posvariablenode_ns_1_i_2003_Argument_0_0, &endvariablenode_ns_1_i_2003_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2003_Argument_0_0_struct.ValueRank, &UA_TYPES[UA_TYPES_INT32], &posvariablenode_ns_1_i_2003_Argument_0_0, &endvariablenode_ns_1_i_2003_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2003_Argument_0_0_struct.ArrayDimensions[0], &UA_TYPES[UA_TYPES_UINT32], &posvariablenode_ns_1_i_2003_Argument_0_0, &endvariablenode_ns_1_i_2003_Argument_0_0, NULL, NULL);
retVal |= UA_encodeBinary(&variablenode_ns_1_i_2003_Argument_0_0_struct.Description, &UA_TYPES[UA_TYPES_LOCALIZEDTEXT], &posvariablenode_ns_1_i_2003_Argument_0_0, &endvariablenode_ns_1_i_2003_Argument_0_0, NULL, NULL);
}
size_t variablenode_ns_1_i_2003_Argument_0_0_encOffset = (uintptr_t)(posvariablenode_ns_1_i_2003_Argument_0_0-variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.data);
variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.length = variablenode_ns_1_i_2003_Argument_0_0_encOffset;
UA_Byte *variablenode_ns_1_i_2003_Argument_0_0_newBody = (UA_Byte *) UA_malloc(variablenode_ns_1_i_2003_Argument_0_0_encOffset);
memcpy(variablenode_ns_1_i_2003_Argument_0_0_newBody, variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.data, variablenode_ns_1_i_2003_Argument_0_0_encOffset);
UA_Byte *variablenode_ns_1_i_2003_Argument_0_0_oldBody = variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.data;
variablenode_ns_1_i_2003_Argument_0_0->content.encoded.body.data = variablenode_ns_1_i_2003_Argument_0_0_newBody;
UA_free(variablenode_ns_1_i_2003_Argument_0_0_oldBody);

UA_ExtensionObject variablenode_ns_1_i_2003_variant_DataContents[1];
variablenode_ns_1_i_2003_variant_DataContents[0] = *variablenode_ns_1_i_2003_Argument_0_0;
UA_Variant_setArray(&attr.value, &variablenode_ns_1_i_2003_variant_DataContents, (UA_Int32) 1, &UA_TYPES[UA_TYPES_EXTENSIONOBJECT]);
attr.displayName = UA_LOCALIZEDTEXT("", "InputArguments");
attr.description = UA_LOCALIZEDTEXT("", "InputArguments");
attr.writeMask = 0;
attr.userWriteMask = 0;
...
UA_free(variablenode_ns_1_i_2003_Argument_0_0_struct.ArrayDimensions);
UA_ExtensionObject_delete(variablenode_ns_1_i_2003_Argument_0_0);
return retVal;
}
